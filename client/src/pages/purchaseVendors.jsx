...
const PurchaseVendor = ({ user }) => {
    ...
    const fetchCustomers = async () => {
      ...
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/supplier/all-suppliers`,
          {
  ...
  return (
    <div className="container mx-auto px-4 py-4 bg-gray-50">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="mt-1 ml-1 text-gray-500 text-sm">
                Manage and track your vendor information
              </p>
            </div>
          </div>
          <Button
      ...
      {/* Search and Filters */}
      <div className=" rounded-2xl  pl-1 pr-2 pt-1 mb-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Select defaultValue="all" onValueChange={handleFilterChange}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="customerId">GSTIN</SelectItem>
                  <SelectItem value="gstin">Name</SelectItem>
